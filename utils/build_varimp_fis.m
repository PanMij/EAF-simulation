function fis = build_varimp_fis()
    ...
    fis = addMF(fis, 'FSI_n', 'trimf', [0 0 0.5], 'Name', 'small');
    fis = addMF(fis, 'FSI_n', 'trimf', [0 0.5 1], 'Name', 'medium');
    fis = addMF(fis, 'FSI_n', 'trimf', [0.5 1 1], 'Name', 'large');

    % Input 2: normalized SampEn
    fis = addInput(fis, [0 1], 'Name', 'SampEn_n');
    fis = addMF(fis, 'SampEn_n', 'trimf', [0 0 0.5], 'Name', 'small');
    fis = addMF(fis, 'SampEn_n', 'trimf', [0 0.5 1], 'Name', 'medium');
    fis = addMF(fis, 'SampEn_n', 'trimf', [0.5 1 1], 'Name', 'large');
    ...
    rules = [ ...
        ...
        2 2 3 1 1  % F medium, S medium -> ZO
